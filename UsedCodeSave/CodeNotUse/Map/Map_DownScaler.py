...
def plot_us_map(
    ...
    for period in tqdm(periods):
        ...
        grid_concentration_vna_ozone = df_period["v"].values.reshape(longitudes.shape)
        ...
        fig = show_maps(
            ...
            panel_layout=layout,
            delta_map_settings={  # For delta map settings, we can leave it as is.
                "cmap": cmap_delta,
        ...
        if save_path is not None:
            save_file = os.path.join(save_path, f"{period}_model_vna_ozone_data_fusion.png")
...
if __name__ == "__main__":
    ...
    model_file = r"/backupdata/data_EPA/EQUATES/EQUATES_data/CMAQv532_DSFusion_12US1_2011.nc"
    ...
    file_list = [
        "/DeepLearning/mnt/shixiansheng/data_fusion/output/DownScaler_July_2011_Trans.csv"
    ]
    save_path = os.path.join(save_path, "DownScaler_2011_July")
