...
def plot_boxplots(data, output_dir='/DeepLearning/mnt/shixiansheng/data_fusion/output/boxplots'):
    ...
    # 定义方法顺序和颜色映射
    ozone_columns = ['model', 'vna_ozone', 'evna_ozone', 'avna_ozone', 'ds_ozone','harvard_ml']
    method_colors = {
        'model': '#d62728',      # 红色
        'vna_ozone': '#1f77b4',  # 蓝色
...
def main():
    ...
    try:
        ...
        data_delta_path = "/DeepLearning/mnt/shixiansheng/data_fusion/output/DailyData_WithoutCV_Delta/2016-2002_Data_WithoutCV_Metrics.csv"
