...
input_file = os.path.join(data_fusion_dir, "DFT_eVNAaVNA_2011_0101-0102_daily.csv")  # 修改为实际的文件名
...
# 保存合并后的数据
output_file = '/DeepLearning/mnt/shixiansheng/data_fusion/output/DFTtrans_eVNAaVNA_2011_0101-0102_daily.csv'
