...
def extract_key_period(period):
    ...
    """
    key_periods = ["JFM", "AMJ", "JAS", "OND", 'Annual', 'Apr-Sep']  # Add more if needed
...
def plot_us_map(
    ...
    for key_period in tqdm(key_periods):
        ...
        grid_avna_ozone_x = df_x_period["avna_ozone"].values.reshape(longitudes.shape)
...
if __name__ == "__main__":
    ...
    fusion_output_file_y = r"/DeepLearning/mnt/shixiansheng/data_fusion/output/2011_daily_DF_Summer season average (Apr-Sep) of O3-MDA8.csv"
    # fusion_output_file_y = r"/DeepLearning/mnt/shixiansheng/data_fusion/output/2011_daily_DF_seasonal_O3-MDA8.csv"
    fusion_output_file_x = r"/DeepLearning/mnt/shixiansheng/data_fusion/output/seasonal_fused_data_2011_AnnualApr.csv"
