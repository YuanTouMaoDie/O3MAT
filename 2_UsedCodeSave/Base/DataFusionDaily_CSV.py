...
def start_daily_data_fusion(model_file, monitor_file, region_table_file, file_path, monitor_pollutant="ozone",
    ...
    df_model[['ROW', 'COL']] = df_model[['ROW', 'COL']] - 0.5
    ...
    df_obs_grouped["mod"] = df_model['model'].values[0]
...
if __name__ == "__main__":
    ...
    monitor_file = r"/DeepLearning/mnt/shixiansheng/data_fusion/output/W126/2011_Monitor_W126_SameSiteWithSMATAddMissing.csv"
    region_table_file = r"/DeepLearning/mnt/shixiansheng/data_fusion/output/Region/Region_CONUSHarvard.csv"

    daily_output_path = os.path.join(save_path, "2011_W126_ST_AtF_SameWithSMATAddMissing.csv")
