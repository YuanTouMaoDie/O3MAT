...
def start_hourly_data_fusion(model_files, monitor_file, region_table_file, file_path, monitor_pollutant="O3",
    ...
    with tqdm(dates) as pbar:
        for date in pbar:
            ...
            # 模型时间往后推4小时（美东时间转 UTC 时间）
            adjusted_date = date + pd.Timedelta(hours=4)
...
if __name__ == "__main__":
    ...
    # 指定日期范围
    start_date = '2011/08/01 22:00'
    end_date = '2011/08/01 23:00'

    daily_output_path = os.path.join(save_path, "2011_SixDataset_Hourly_True_Test_1.csv")
